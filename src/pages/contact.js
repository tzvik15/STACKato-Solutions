  ...
  return (
    <div className="contactbox" id="contact">
      ...
      <p className="break">
        ...
        <a href="mailto:stackatosolutions@gmail.com" className="hereLink">HERE</a>, or by phone at
        303.667.4813
      </p>
      <p className="break">
        You can find my GitHub page{" "}
        <a href="https://github.com/tzvik15" target="_blank" rel="noopener noreferrer" className="hereLink">
          HERE
        </a>
