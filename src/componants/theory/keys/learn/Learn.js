...
<div className="cfDiv">
        ...
        <button className= "ans1But" onClick={reset}><Link to="/Theory/keys/learn">DONE!</Link></button>
</div>
        </>
        :
        state.q1===true && state.q2===true && state.isCorF===false && state.q3===false?
        <>
        <p className ="headTest">Now we are ready to ask the final question: does the name of the scale have the word "flat" (or the symbol "b") in it? Examples that have it are Bb, Ab, Db. Examples that don't are F#, G#, A, B.</p>
        <div className="q3Div">
        <button className= "ans1But" onClick={flat}>Yes it does!</button>
        <button className= "ans1But" onClick={sharp}>No it doesn't!</button>
        </div>
        </>
        :
...
<div className="flatDiv">
        ...
        <h3 className ="headTest">Example:</h3>
        ...
        <button className= "ans1But" onClick={reset}><Link to="/Theory/keys">Got It!</Link></button>
        </div>
        </>
        :
        state.q1===true && state.q2===true && state.q3===true && state.hasFlat===false?
        <>
        <div className="sharpDiv">
...
<div className="minDiv">
        ...
        <h3 className ="headTest">Found your relative major? AWESOME! Click the button when you are ready.</h3>
